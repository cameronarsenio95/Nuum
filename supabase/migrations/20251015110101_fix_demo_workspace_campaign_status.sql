/*
  # Fix Demo Workspace Campaign Status

  ## Overview
  Updates the create_demo_workspace_from_template function to use valid campaign status values
  
  ## Changes
  - Change 'planning' status to 'draft' to comply with campaigns_status_check constraint
  - Ensure all status values are valid: draft, active, completed, archived

  ## Important Notes
  - This is a bug fix for constraint violation
*/
