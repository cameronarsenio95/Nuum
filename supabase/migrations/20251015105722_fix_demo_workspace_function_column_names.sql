/*
  # Fix Demo Workspace Function Column Names

  ## Overview
  Updates the create_demo_workspace_from_template function to use correct column names
  
  ## Changes
  - Change `revenue` to `total_revenue` in INSERT statements
  - Ensure all column names match the actual campaigns table schema

  ## Important Notes
  - This is a bug fix for the demo workspace creation function
*/
