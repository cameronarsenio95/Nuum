                ...
                {topCreators.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {topCreators.map((creator, index) => {
                      ...
                      return (
                        <div key={creator.id} className="flex items-start justify-between gap-4 dark:bg-linear-bg-tertiary/40 light:bg-gray-50 rounded-linear-lg p-4 hover:dark:bg-linear-bg-tertiary/60 linear-transition">
