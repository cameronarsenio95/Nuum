            ...
            return (
              <div key={member.id} className={`p-4 ${isMemberOwner ? 'bg-linear-bg-subtle' : ''}`}>
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isMemberOwner ? 'bg-linear-accent text-black' : 'bg-linear-bg-subtle text-text-secondary'}`}>
