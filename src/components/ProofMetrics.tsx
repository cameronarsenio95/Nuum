      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {metrics.map((metric, index) => (
            <div
              key={index}
              className="border rounded-linear-lg p-8 text-center linear-transition dark:bg-linear-bg-secondary dark:border-linear-border-subtle dark:hover:border-linear-border light:bg-white light:border-gray-200 light:shadow-md light:hover:shadow-lg light:hover:border-gray-300"
            >
