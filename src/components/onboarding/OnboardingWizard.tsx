...
export function OnboardingWizard({ onComplete, onSkip }: OnboardingWizardProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="dark:bg-linear-bg-secondary light:bg-white border dark:border-linear-border light:border-linear-light-border rounded-linear-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 dark:bg-linear-bg-secondary light:bg-white border-b dark:border-linear-border-subtle light:border-linear-light-border p-6 flex items-center justify-between">
        ...
        <div className="sticky bottom-0 dark:bg-linear-bg-secondary light:bg-white border-t dark:border-linear-border-subtle light:border-linear-light-border p-6 flex items-center justify-between">
          <button
